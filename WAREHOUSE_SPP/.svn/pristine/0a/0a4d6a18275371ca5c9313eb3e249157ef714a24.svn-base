...
{
    /// <summary>
    /// Interaction logic for frm_lapphieu_yeucau_nhapkho.xaml
    /// </summary>
    public partial class frm_lapphieu_yeucau_nhapkho : ControlBase
    {
        ...
        IYEUCAU_NHAPXUATKHOBussiness _IYEUCAU_NHAPXUATKHOBussiness;
        DataRow iRowSelGb = null;
        public frm_lapphieu_yeucau_nhapkho()
        {
            InitializeComponent();
            Initialize_Grid_LapPhieu_YeuCau_NhapKho();
            Initialize_Grid_ctiet();
            _IYEUCAU_NHAPXUATKHOBussiness = new YEUCAU_NHAPXUATKHOBussiness(string.Empty);
        ...
        private void Initialize_Grid_LapPhieu_YeuCau_NhapKho()
        {
            try
            {
                ...
                xColumn = new Column("CreateDate", "Ngày tạo hệ thống");
                xColumn.Width = 120;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("CreateBy", "Người tạo");
                xColumn.Width = 80;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("ModifiedDate", "Ngày sửa");
                xColumn.Width = 80;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("ModifiedBy", "Người sửa");
                xColumn.Width = 80;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
        ...
        public void LoadData()
        {
            try
            {
                using (var task = new AsyncTaskProcess(this))
                {
                    ...
                    {
                        task.SetCallContext();
                        return _IYEUCAU_NHAPXUATKHOBussiness.getKO_PHIEUYEUCAU_NHAPXUATKHO_ALL(ConstCommon.DonViQuanLy,"N");
                    });
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_lapphieu_yeucau_nhapkho_popup", null,"N");
                LoadData();
            }
            catch (Exception ex)
            {
        ...
        private void grdView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            try
            {
                ...
                DataRow[] iRowSelGb_ctiet = iGridDataSource_dataset.Tables[1].Select("PHIEUYEUCAU_NHAPXUATKHO_ID=" +  ConstCommon.NVL_NUM_LONG_NEW(iRowSelGb["PHIEUYEUCAU_NHAPXUATKHO_ID"]));

                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_lapphieu_yeucau_nhapkho_popup", iRowSelGb, iRowSelGb_ctiet,"N");
                LoadData();
            }
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                bool result = _IYEUCAU_NHAPXUATKHOBussiness.KO_PHIEUYEUCAU_NHAPXUATKHO_DELETE_BYID(ConstCommon.DonViQuanLy, ConstCommon.NVL_NUM_LONG_NEW(iRowSelGb["PHIEUYEUCAU_NHAPXUATKHO_ID"].ToString()), CommonDataHelper.UserName);
                if (!result)
                {
        ...
        private void grdViewLapPhieuYeuCauNhapKho_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                DispalayRequest();
                DataRow[] iRowSelGb_ctiet = iGridDataSource_dataset.Tables[1].Select("PHIEUYEUCAU_NHAPXUATKHO_ID=" + ConstCommon.NVL_NUM_LONG_NEW(iRowSelGb["PHIEUYEUCAU_NHAPXUATKHO_ID"]));
                if (iRowSelGb_ctiet.Length>0)
                {
                    this.iGridHelper_ctiet.BindItemSource(iRowSelGb_ctiet.CopyToDataTable());
                }
                else
                {
