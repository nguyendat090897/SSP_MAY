...
namespace DSofT.Warehouse.UI
{
    ...
    ///  Editor:      
    ///  Modify date: 
    ///  Description: Danh muc nguyen lieu
    /// </summary>
    public partial class frmDanhMucNguyenLieu : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frmDanhMucNguyenLieu()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void Initialize_Grid()
        {
            try
            {
                ...
                xColumn = new Column("NhomNguyenLieu", Convert.ToString(UtilLanguage.ApplyLanguage()["frmDMNguyenLieu_NhomNguyenLieu"]));
                xColumn.Width = 150;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("TieuChuanDuocChat", Convert.ToString(UtilLanguage.ApplyLanguage()["frmDMNguyenLieu_TieuChuan"]));
                xColumn.Width = 80;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("DiaChiNhaSX", Convert.ToString(UtilLanguage.ApplyLanguage()["frmDMNguyenLieu_DiaChiNhaSX"]));
                xColumn.Width = 150;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frmDanhMucNguyenLieu_popup", null);
                //LoadData();
            }
            catch (Exception ex)
            {
