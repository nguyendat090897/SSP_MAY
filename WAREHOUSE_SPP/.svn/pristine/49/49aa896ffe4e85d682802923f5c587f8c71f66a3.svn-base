...
namespace DSofT.Warehouse.UI
{
    ...
    ///  Description: Canh bao hang sap het han su dung
    /// </summary>
    public partial class frm_canh_bao_hang_sap_het_han_su_dung : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frm_canh_bao_hang_sap_het_han_su_dung()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void Initialize_Grid()
        {
            try
            {
                ...
                xColumn = new Column("KhoLuuTru", Convert.ToString(UtilLanguage.ApplyLanguage()["lblKhoLuuTru"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("TonViTri", Convert.ToString(UtilLanguage.ApplyLanguage()["lblTonViTri"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("HanSuDung", Convert.ToString(UtilLanguage.ApplyLanguage()["lblHanSuDung"]));
                xColumn.Width = 80;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("SoNgayCanhBao", Convert.ToString(UtilLanguage.ApplyLanguage()["lblSoNgayCanhBao"]));
                xColumn.Width = 150;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("SoNgayConHSD", Convert.ToString(UtilLanguage.ApplyLanguage()["lblSoNgayConHSD"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
        ...
        private void btnChuyenSangBT_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_canh_bao_hang_sap_het_han_su_dung_popup", null);
                //LoadData();
            }
            catch (Exception ex)
            {
                UtilLog.WriteLogToDB(LogGroupName.PROGRAM, ex.Message, this.GetType().Name, this.btnChuyenSangBT.Tag.ToString());
                base.ShowMessage(MessageType.Error, ex.Message, ex);
            }
        }
