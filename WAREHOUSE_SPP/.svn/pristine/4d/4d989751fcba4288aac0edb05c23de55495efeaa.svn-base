...
{
    public interface IXD_DM_TTTVIETProvider
    {
    ...
    public class XD_DM_TTTVIETProvider : BaseSqlExecute, IXD_DM_TTTVIETProvider
    {
        public XD_DM_TTTVIETProvider(string appId, string userId) :
        ...
        public DataSet getHT_DINHMUC_TEMTOA(string pMA_DVIQLY, long pDINHMUC_TEMTOA_ID)
        {
            ...
            var result = base.ExecuteDataSet("getHT_DINHMUC_TEMTOA", sqlParams);
            if (result != null)
            {
                return result;
            }
        ...
        public DataTable DM_DONVI_TINH_GET_LIST_ALL()
        {
            ...
            var result = base.ExecuteDataSet("DM_DONVI_TINH_GET_LIST_ALL", sqlParams);
            if (result != null)
            {
        ...
        public DataSet getHT_DINHMUC_TEMTOA_ALL(string pMA_DVIQLY)
        {
            ...
            var result = base.ExecuteDataSet("getHT_DINHMUC_TEMTOA_ALL", sqlParams);
            if (result != null)
            {
                return result;
            }
        ...
        public bool HT_DINHMUC_TEMTOA_CHECKEXISTS(string pMA_DVIQLY,long pDINHMUC_TEMTOA_ID, long pSANPHAM_ID)
        {
            ...
            var result = base.ExecuteDataSet("HT_DINHMUC_TEMTOA_CHECKEXISTS", sqlParams);
            if ((result != null) && (ConstCommon.NVL_NUM_NT_NEW(result.Tables[0].Rows[0][0]) > 0))
            {
                return true;
            }
        ...
        {
            var sqlParams = new object[] { pMA_DVIQLY,  pSANPHAM_ID };
            var result = base.ExecuteDataSet("HT_DINHMUC_TEMTOA_CHECKEXISTS_YCDV", sqlParams);
            if ((result != null) && (ConstCommon.NVL_NUM_NT_NEW(result.Tables[0].Rows[0][0]) > 0))
            {
                return true;
            }
