...
namespace DSofT.Warehouse.UI
{
    ...
    ///  Editor:      
    ///  Modify date: 
    ///  Description: Xay dung dinh muc san pham - Lap phieu xuat tu PYC
    /// </summary>
    public partial class frm_lap_phieu_xuat_tu_PYC : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frm_lap_phieu_xuat_tu_PYC()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_lap_phieu_xuat_tu_PYC_popup", null);
            }
            catch (Exception ex)
            {
