...
{
    /// <summary>
    /// Interaction logic for frm_dm_sanphamkhac.xaml
    /// </summary>
    public partial class frm_dm_sanphamkhac : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frm_dm_sanphamkhac()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_dm_sanphamkhac_popup", null);
        ...
        private void grdView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                // object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_dm_sanphamkhac_popup", iRowSelG
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_dm_sanphamkhac_popup", null);
            }
            catch (Exception ex)
            {
