...
base(DbCommon.WarehouseDbConnstr, appId, userId)
        ...
        {
            var sqlParams = new object[] { pMA_DVIQLY, pKHO_KHUVUC_NCC_ID, pKHO_ID, pKHO_KHUVUC_ID, pKHACHHANG_NCC_ID };
            var result = base.ExecuteDataSet("DM_KHO_KHUVUC_NCC_CHECKEXISTS", sqlParams);
