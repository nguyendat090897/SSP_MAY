...
namespace DSofT.Warehouse.UI
{
    ...
    public partial class frmQuanLyChi_Popup : PopupBase
    {
        ...
        void SetFocus()
        {
            ...
            {
                base.ShowMessage(MessageType.Information, "SỐ PHIẾU CHI " + Convert.ToString(UtilLanguage.ApplyLanguage()["lblNoteNULL"]));
                return;
            }
        ...
        {
            if (cbbNCC.Text == "--Chọn--" || cbbTenHD.Text == "--Chọn--" || txtSoPhieuChi.Text == string.Empty || txtSoTien.Text == string.Empty || dtpNgayPhieu.Text == string.Empty || txtHO_TEN_NGUOINOP.Text == string.Empty || txtDIA_CHI_NGUOINOP.Text == string.Empty)
                SetFocus();
            else
            {
        ...
        private void btnIn_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string templaleFileName = "RP_CHI.xlsx";
