...
namespace DSofT.Warehouse.UI
{
    ...
    /// </summary>
    public partial class frm_XDDinhMuc_BoSung_TTTViet_KhaiBaoCPDV : PopupBase
    {
        ...
        public frm_XDDinhMuc_BoSung_TTTViet_KhaiBaoCPDV()
        {
            InitializeComponent();
        ...
        {
            dtTenDV = XD_DM_TTTVIETBussiness.GetListHT_DINHMUC_TEMTOA_CHIPHI_DV_GET_TENDV(ConstCommon.DonViQuanLy);
        }
        ...
        private void LoadData()
        {
            try
            {
                using (var task = new AsyncTaskProcess(this))
                {
                    ...
                    {
                        task.SetCallContext();
                        return XD_DM_TTTVIETBussiness.HT_DINHMUC_TEMTOA_CHIPHI_DV_GET_LIST_ALL(ConstCommon.DonViQuanLy, ConstCommon.NVL_NUM_LONG_NEW(iRowSelGb["DINHMUC_TEMTOA_ID"].ToString()));
                    });
        ...
        void xButton_RemoveClick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (ConstCommon.NVL_NUM_LONG_NEW(row["DINHMUC_TEMTOA_CHIPHI_DV_ID"]) > 0)
                {
                    ...
                    if (msg == true)
                    {
                        DataTable dsReturn = XD_DM_TTTVIETBussiness.HT_DINHMUC_TEMTOA_CHIPHI_DV_DELETE(ConstCommon.DonViQuanLy, ConstCommon.NVL_NUM_LONG_NEW(row.Row["DINHMUC_TEMTOA_CHIPHI_DV_ID"]), CommonDataHelper.UserName);
        ...
        private void btnChapNhan_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < this.iGridDataSource.Rows.Count - 1; i++)
                {
                    ...
                    result = XD_DM_TTTVIETBussiness.InsertOrUpdateHT_DINHMUC_TEMTOA_CHIPHI_DV(dtCPDV);
                }
        ...
        private void tinhCPDV()
        {
            ...
            try
            {
                ...
                gb = frm_XDDinhMuc_BoSung_TTTViet_Popup.tinhgn + (frm_XDDinhMuc_BoSung_TTTViet_Popup.tinhgn * frm_XDDinhMuc_BoSung_TTTViet_Popup.tyle) + CPDV;
                ...
                result = XD_DM_TTTVIETBussiness.UpdateHT_DINHMUC_TEMTOA_CPDV(dtTinhCPDV);
