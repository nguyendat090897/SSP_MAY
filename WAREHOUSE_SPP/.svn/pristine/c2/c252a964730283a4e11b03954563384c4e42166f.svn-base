...
{
    /// <summary>
    /// Interaction logic for frm_bo_sung_tem_toa_popup.xaml
    /// </summary>
    public partial class frm_bo_sung_tem_toa_popup : PopupBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataRow iRowSelGb = null;
        public frm_bo_sung_tem_toa_popup()
        {
            InitializeComponent();
            Initialize_Grid();
