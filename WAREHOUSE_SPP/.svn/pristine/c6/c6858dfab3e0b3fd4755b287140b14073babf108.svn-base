...
{
    /// <summary>
    /// Interaction logic for frmKiemKeHangHoa_popup_xuatdieuchinh.xaml
    /// </summary>
    public partial class frmKiemKeHangHoa_popup_xuatdieuchinh : PopupBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataRow iRowSelGb = null;
        public frmKiemKeHangHoa_popup_xuatdieuchinh()
        {
            InitializeComponent();
            Initialize_Grid();
