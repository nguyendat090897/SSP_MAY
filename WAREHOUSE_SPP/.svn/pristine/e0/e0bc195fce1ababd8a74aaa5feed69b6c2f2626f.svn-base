...
namespace DSofT.Warehouse.UI
{
    ...
    public partial class frm_KiemKeHangHoa_ChonSP_popup : PopupBase
    {
        ...
        private void cboItemType_EditValueChanged(object sender, DevExpress.Xpf.Editors.EditValueChangedEventArgs e)
        {
            try
            {
                dtSPALL = Yeucauxuatkho_bus.DM_SANPHAM_GET_LIST_ALL_BY_TYPE_TON_KHO(ConstCommon.NVL_NUM_LONG_NEW(this.iDataSource.Rows[0]["KHO_ID"]),ConstCommon.DonViQuanLy, this.iDataSource.Rows[0]["MA_ITEM_TYPE"].ToString());
                if (dtSPALL != null)
                {
