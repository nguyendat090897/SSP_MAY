...
{
    /// <summary>
    /// Interaction logic for frm_DS_Phieu_Lam_Dich_Vu_popup    .xaml
    /// </summary>
    public partial class frm_DS_Phieu_Lam_Dich_Vu_popup : PopupBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataRow iRowSelGb = null;
        public frm_DS_Phieu_Lam_Dich_Vu_popup()
        {
            InitializeComponent();
            Initialize_Grid();
            Initialize_Grid_2();
        ...
        private void Initialize_Grid()
        {
            try
            {
                ...
                xColumn = new Column("MaSPDG", Convert.ToString(UtilLanguage.ApplyLanguage()["lblMaSPDG"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
                ...
                xColumn = new Column("TenSPDG", Convert.ToString(UtilLanguage.ApplyLanguage()["lblTenSPDG"]));
                xColumn.Width = 150;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
        ...
        private void Initialize_Grid_3()
        {
            iGridHelper = null;
            try
            {
                this.iGridHelper = new GridHelper(this.grd_3, this.grdView_3, false);
                Column xColumn;
                ...
                xColumn = new Column("MaNL", Convert.ToString(UtilLanguage.ApplyLanguage()["frmQuantitativeFood_MaterialCode"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
                ...
                xColumn = new Column("TenNL", Convert.ToString(UtilLanguage.ApplyLanguage()["frmQuantitativeFood_MaterialName"]));
                xColumn.Width = 150;
                xColumn.Visible = true;
                xColumn.HorizontalContentAlignment = DevExpress.Xpf.Editors.Settings.EditSettingsHorizontalAlignment.Left;
                xColumn.AllowEditing = DevExpress.Utils.DefaultBoolean.False;
            ...
            {
                UtilLog.WriteLogToDB(LogGroupName.PROGRAM, ex.Message, this.GetType().Name, "Initialize_Grid_3()");
                base.ShowMessage(MessageType.Error, ex.Message, ex);
            }
        }
        /// <summary>
