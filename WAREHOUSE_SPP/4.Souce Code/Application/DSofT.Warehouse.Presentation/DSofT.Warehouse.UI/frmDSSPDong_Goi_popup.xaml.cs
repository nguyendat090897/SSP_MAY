...
{
    /// <summary>
    /// Interaction logic for frmDSSPDong_Goi_popup.xaml
    /// </summary>
    public partial class frmDSSPDong_Goi_popup : PopupBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataRow iRowSelGb = null;
        public frmDSSPDong_Goi_popup()
        {
            InitializeComponent();
            Initialize_Grid();
            Initialize_Grid_2();
        ...
        private void Initialize_Grid()
        {
            try
            {
                ...
                xColumn = new Column("MaThuoc", Convert.ToString(UtilLanguage.ApplyLanguage()["lblMaThuocKH"]));
                xColumn.Width = 100;
                xColumn.Visible = true;
