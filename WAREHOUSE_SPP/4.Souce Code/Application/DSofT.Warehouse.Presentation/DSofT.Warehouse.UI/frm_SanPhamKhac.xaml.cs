...
{
    /// <summary>
    /// Interaction logic for frm_SanPhamKhac.xaml
    /// </summary>
    public partial class frm_SanPhamKhac : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frm_SanPhamKhac()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_SanPhamKhac_popup", null);
        ...
        private void grdView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                // object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_SanPhamKhac_popup", iRowSelG
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_SanPhamKhac_popup", null);
            }
            catch (Exception ex)
            {
