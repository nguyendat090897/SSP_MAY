...
namespace DSofT.Warehouse.UI
{
    ...
    public partial class frm_XDDinhMuc_ChoSP_KhuyenMai_Popup : PopupBase
    {
        ...
        /// <summary>
        /// Initialize_Grid NVL Tieu hao cho cac san pham khuyen mai
        /// </summary>
        ...
        /// <summary>
        /// Xoa dong khai bao san pham khuyen mai
        /// </summary>
        ...
        private bool checkNull()
        {
            ...
            {
                base.ShowMessage(MessageType.Information, " SẢN PHẨM ĐÃ ĐƯỢC KHAI BÁO ĐỊNH MỨC THÔNG TIN TIẾNG VIỆT");
                return false;
            }

            if (this.dt_SP_DGoi.Rows.Count == 0)
            {
                base.ShowMessage(MessageType.Information, "VUI LÒNG CHỌN SẢN PHẨM ĐỂ KHUYẾN MÃI KÈM");
                return false;
            }
