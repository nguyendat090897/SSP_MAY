    ...
    public partial class frm_duyet_phieu_yeu_cau : ControlBase
    {
        ...
        private void grdView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_duyet_phieu_yeu_cau_popup", iRowSelGb, iRowSelGb_ctiet, iRowSelGb_NVL);
                LoadDataGrdDichVu();
            }
            catch (Exception ex)
            {
