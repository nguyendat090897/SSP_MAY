...
{
    /// <summary>
    /// Interaction logic frm_lap_phieu_xuat_tu_PYC_popup for .xaml
    /// </summary>
    public partial class frm_lap_phieu_xuat_tu_PYC_popup : PopupBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataRow iRowSelGb = null;
        public frm_lap_phieu_xuat_tu_PYC_popup()
        {
            InitializeComponent();
            Initialize_Grid();
            Initialize_Grid_2();
        ...
        private void btnTaoPhieuXuatSP_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_phieu_xuat_kho_san_pham_dich_vu_popup", null);
            }
            catch (Exception ex)
            {
                UtilLog.WriteLogToDB(LogGroupName.PROGRAM, ex.Message, this.GetType().Name, "btnTaoPhieuXuatSP_Click()");
                base.ShowMessage(MessageType.Error, ex.Message, ex);
            }
        }
        private void btnTaoPhieuXuatNVL_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_phieu_xuat_kho_vat_tu_dich_vu_popup", null);
            }
            catch (Exception ex)
            {
                UtilLog.WriteLogToDB(LogGroupName.PROGRAM, ex.Message, this.GetType().Name, "btnTaoPhieuXuatNVL_Click()");
                base.ShowMessage(MessageType.Error, ex.Message, ex);
            }
        }
    }
