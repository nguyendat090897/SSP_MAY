...
namespace DSofT.Warehouse.UI
{
    ...
    /// </summary>
    public partial class frm_lapphieu_yeucau_xuatkho : ControlBase
    {
        ...
        public frm_lapphieu_yeucau_xuatkho()
        {
            InitializeComponent();
        ...
        public void LoadData()
        {
            try
            {
                using (var task = new AsyncTaskProcess(this))
                {
                    ...
                    {
                        task.SetCallContext();
                        return _IYEUCAU_NHAPXUATKHOBussiness.getKO_PHIEUYEUCAU_NHAPXUATKHO_ALL(ConstCommon.DonViQuanLy,"X");
                    });
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_lapphieu_yeucau_nhapkho_popup", null,"X");
                LoadData();
            }
            catch (Exception ex)
            {
        ...
        private void grdView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            try
            {
                ...
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_lapphieu_yeucau_nhapkho_popup", iRowSelGb, iRowSelGb_ctiet,"X");
                LoadData();
            }
            catch (Exception ex)
            {
