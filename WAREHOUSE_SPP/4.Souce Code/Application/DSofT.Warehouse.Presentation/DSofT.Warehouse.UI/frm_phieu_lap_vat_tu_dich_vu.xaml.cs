...
namespace DSofT.Warehouse.UI
{
    ...
    ///  Editor:      
    ///  Modify date: 
    ///  Description: Xay dung dinh muc san pham - Phieu lap vat tu dich vu
    /// </summary>
    public partial class frm_phieu_lap_vat_tu_dich_vu : ControlBase
    {
        DataTable iDataSource = null;
        GridHelper iGridHelper = null;
        DataTable iGridDataSource = null;
        public frm_phieu_lap_vat_tu_dich_vu()
        {
            InitializeComponent();
            Initialize_Grid();
        ...
        private void btnNew_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                object xReturn = UIAgent.GetUIPopupDialog(this, null, this.GetType().ToString(), "DSofT.Warehouse.UI", "frm_phieu_lap_vat_tu_dich_vu_popup", null);
            }
            catch (Exception ex)
            {
